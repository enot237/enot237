...
- 📈 **SLA 99.9%** после перестройки инфраструктуры
- ⚡ Ускорение legacy-сервисов **до 3×**
- 🚀 Полный CI/CD: деплой в прод **< 5 минут**, rollback — секунды
- 🤖 AI-система распознавания документов: **92% точность в проде**
...
## 🧠 Мой подход
> Не использую “модные комбайны” без понимания, как они работают внутри.  
> Люблю простые, надёжные решения, которые выдерживают прод и high-load.

- Проактивность и ownership
- Документация, postmortem, процессы
- Менторинг L2/L3 и джун-DevOps
